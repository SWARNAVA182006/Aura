...
export const TIMELINE_EVENTS: TimelineEntry[] = [
  {
    ...
    description: "Started B.Tech in Computer Science (AI & ML), building strong foundations in software engineering, AI, mathematics, and systems.",
    highlights: ["B.Tech CSE (AI & ML) foundation", "Software engineering, AI, mathematics & systems"],
    skillsUsed: ["Python", "C++", "C", "Java", "Data Structures", "OOP", "DBMS"],
    logoSrc: "/assets/srm.png",
    proofSrc: "/assets/srm.png",
  },
  {
    period: "2023 — Present",
    title: "Undergraduate Research Scholar (UROP)",
    organization: "Undergraduate Research Programme",
    type: "Research",
    location: "Chennai, India",
    description: "Research under Dr. Vidhya B focusing on AI, Computer Vision, IoT systems, and intelligent environmental monitoring.",
    highlights: ["Research scholar under Dr. Vidhya B", "AI, Computer Vision, IoT & Edge AI systems"],
    skillsUsed: ["Research", "Computer Vision", "IoT", "Edge AI", "Python"],
    logoSrc: "/assets/urop.jpg",
    proofSrc: "/assets/urop.jpg",
  },
  {
    period: "2024",
    ...
    type: "Internship",
    location: "Virtual",
    description: "Completed Google's AI/ML Virtual Internship through AICTE & EduSkills covering modern ML workflows and TensorFlow.",
    highlights: ["Google AI/ML Virtual Internship", "Modern ML workflows & TensorFlow training"],
    skillsUsed: ["TensorFlow", "Google Cloud", "Python", "Machine Learning"],
    logoSrc: "/assets/google.png",
    proofSrc: "/assets/googlecertificate.jpg",
  },
  {
    period: "2024",
    title: "IBM Machine Learning Certification",
    organization: "IBM",
    type: "Program",
    location: "Virtual",
    description: "Completed IBM Machine Learning certification covering supervised learning, model development, and practical ML workflows.",
    highlights: ["IBM Machine Learning certification", "Supervised learning & practical ML workflows"],
    skillsUsed: ["Python", "Scikit-Learn", "Machine Learning", "IBM Watson"],
    logoSrc: "/assets/ibm.jpg",
    proofSrc: "/assets/ibmcertificate.jpg",
  },
  {
    period: "2024",
    ...
    type: "Program",
    location: "Virtual",
    description: "Completed OpenAI Developer Workshop focused on LLMs, Prompt Engineering, Embeddings, and AI application development.",
    highlights: ["OpenAI Developer Workshop", "LLMs, Prompt Engineering & Embeddings"],
    skillsUsed: ["LLMs", "Prompt Engineering", "Embeddings", "OpenAI API"],
    logoSrc: "/assets/openai.jpg",
    proofSrc: "/assets/openaicertificate.jpg",
  },
  {
    period: "2024",
    ...
    description: "Worked on AI backend systems, intelligent search pipelines, and Retrieval-Augmented Generation (RAG) applications.",
    highlights: ["AI backend systems & search pipelines", "Retrieval-Augmented Generation (RAG) applications"],
    skillsUsed: ["FastAPI", "Python", "RAG", "Qdrant", "LangChain"],
    logoSrc: "/assets/studai.jpg",
    proofSrc: "/assets/studcertificate.jpg",
  },
  {
    period: "2024",
    title: "AI & ML Industrial Intern | ONGC",
    organization: "Oil and Natural Gas Corporation (ONGC)",
    type: "Internship",
    location: "India",
    description: "Developed AI solutions for seismic interpretation, geophysical data processing, and computer vision, leading to SeisVision AI.",
    highlights: ["Subsurface seismic data processing", "Geophysical AI & computer vision solutions"],
    skillsUsed: ["Seismic AI", "SEG-Y", "Computer Vision", "PyTorch", "Python"],
    logoSrc: "/assets/ongc.png",
    proofSrc: "/assets/ongccertificate.jpg",
  },
  {
    period: "2024",
    ...
    description: "Developed PerformPro, an AI-powered employee performance and analytics platform for TechForce Academy, Australia.",
    highlights: ["PerformPro AI platform engineering", "Full stack employee analytics dashboard"],
    skillsUsed: ["React", "FastAPI", "PostgreSQL", "Full Stack", "AI"],
    logoSrc: "/assets/techforce.png",
    proofSrc: "/assets/techforcecertificate.jpg",
  },
  {
    period: "2025",
    title: "UYIR National Road Safety Hackathon – Grand Finalist",
    organization: "UYIR Road Safety",
    type: "Competition",
    location: "Coimbatore / India",
    description: "Selected as a National Grand Finalist for building an AI-powered Smart Traffic Signalling System for intelligent road safety and traffic optimization.",
    highlights: ["National Grand Finalist placement", "AI-powered Smart Traffic Signalling System"],
    skillsUsed: ["Computer Vision", "AI", "Smart Traffic", "IoT", "Edge AI"],
    logoSrc: "/assets/uyircertificate.jpg",
    proofSrc: "/assets/uyircertificate.jpg",
  },
  {
    period: "2025",
    title: "Apple Student Developer Program",
    organization: "Apple Developer Program",
    type: "Program",
    location: "Chennai / Cupertino",
    description: "Selected for Apple's Student Developer Program, building native iOS applications using Swift and SwiftUI.",
    highlights: ["Apple Student Developer selection", "Native iOS & Swift/SwiftUI app development"],
    skillsUsed: ["Swift", "SwiftUI", "iOS Development", "Apple Ecosystem"],
    logoSrc: "/assets/ios.jpg",
    proofSrc: "/assets/ios.jpg",
  },
];
...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    githubUrl: "https://github.com/SWARNAVA182006/AutisMind.git",
    caseStudy: {
